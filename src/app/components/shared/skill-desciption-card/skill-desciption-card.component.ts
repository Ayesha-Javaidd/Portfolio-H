...
@Component({
  selector: 'app-skill-desciption-card',
  imports: [CommonModule],
  templateUrl: './skill-desciption-card.component.html',
  styleUrl: './skill-desciption-card.component.css',
})
export class SkillDesciptionCardComponent {
